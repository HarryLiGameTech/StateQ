...
impl ControlQubitSet {
    ...
    pub fn control(&mut self, qubits: &QubitAccessor, condition: bool) {
        if condition {
    ...
    pub fn control_one(&mut self, qubits: &QubitAccessor) {
        self.ones.add(qubits);
    }

    pub fn control_zero(&mut self, qubits: &QubitAccessor) {
        self.zeros.add(qubits);
    }

    pub fn decontrol_one(&mut self, qubits: &QubitAccessor) {
        self.ones -= qubits.clone().into();
    }

    pub fn decontrol_zero(&mut self, qubits: &QubitAccessor) {
        self.zeros -= qubits.clone().into();
    }

    pub fn decontrol(&mut self, qubits: &QubitAccessor) {
